          ...
          <div class="forecast-container">
            <div class="today forecast">
              <div class="forecast-header">
                <div class="day">Notification</div>
                <div class="notifi"><marquee>| <span id="not-title">TITLE</span> | <span id="not-msg"> This is the alert!</span></marquee></div>
              </div> 
            </div>
          </div>
        </div>
          ...
          <div class="card-body flex-panel">
            ...
            <a href="weather_report.php">
              <div class="panel-item">
                <div class="item-title"><center><i class="fas fa-umbrella" style="font-size: 70px;"></i></center><br>Weather Forcast</div>
                
              </div>
            </a>
            <a href="weather_gen.php">
              <div class="panel-item">
                <div class="item-title"><center><i class="far fa-newspaper" style="font-size: 70px;"></i></center><br>Weather Reporting</div>
              </div>
            </a>
