...
<body id="page-top" onload="getLocationGraph(6.5854, 79.9607)">
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="weather_gen.php">
            ...
            <div class="lg-card-container">
                ...
                <div class="card">
                    ...
                    <div class="content"  style="background: url('images/wallpaper/kalutara.jpg'); 
                        ...
                        <a class="btn-card-lg" href="weather_report_single.php?city=Kalutara">Click Here</a>
                ...
                <div class="card">
                    ...
                    <div class="content" style="background: url('images/wallpaper/colombo.jpg'); 
                        ...
                        <a class="btn-card-lg" href="weather_report_single.php?city=Colombo">Click Here</a>
                ...
                <div class="card">
                  ...
                  <div class="content" style="background: url('images/wallpaper/gampaha.jpg'); 
                      ...
                      <div class="wrapper">
                        ...
                        <a class="btn-card-lg" href="weather_report_single.php?city=Gampaha">Click Here</a>
